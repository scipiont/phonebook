...
def start_app():
    while True:
        ...
        match user_choice:
            ...
            case 5:
                find_contacts(text.input_seach_word)
                # search_word = view.input_data(text.input_seach_word)
                # result = model.find_contact(search_word)
                # view.show_contacts(result, text.find_contact_no_result(search_word))
            case 6:
                if find_contacts(text.input_seach_word_for_edit):
            ...
            case 7:
                if find_contacts(text.input_seach_word_for_delete):
